  ...
  return (
    ...
    <main className="flex w-9/12 flex-1 p-8 bg-white rounded shadow-lg pt-20">
      <div className="w-1/2 pr-8 relative m-4">
        <Image src="/images/Mercedes2.JPG" alt="About Us Image" layout="fill" objectFit="cover" className="rounded" />
      </div>
      ...
      <div className="w-1/2 text-center">
        ...
        <Link className="px-4 py-2 bg-blue-500 hover:bg-blue-600 rounded text-white p-4 m-4" href="https://www.autoscout24.ch/de">
            Zeige mehr
        </Link>
